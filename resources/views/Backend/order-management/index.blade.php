            ...
            @foreach ($orders as $order)
                        <a href="{{route('orders.detail', ['order' => $order->order_id])}}">
                            <div class="card mb-4 order-card"
                                ...
                                data-email="{{ optional($order->account)->email ?? '' }}" data-order-id="{{ $order->order_id }}"
                                ...
                                <div class="row g-0">
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <p>
                                                        ...
                                                        {{ optional($order->account)->name ?? 'Không có tên' }}<br>
                                                        <strong>Email:</strong>
                                                        {{ optional($order->account)->email ?? 'Không có email' }}<br>
                                    ...
                                    <div class="col-md-3 d-flex align-items-center justify-content-end"
                                        ...
                                        <div style="display: flex; flex-direction: row; gap: 10px;">
                                            ...
                                            @if (optional($order->payments->first())->status_deposit != 2)
                                                <span
                                                    style="font-size: 14px; background-color: {{ $statusColorPaymentAll }}; color: {{ $colorTextPaymentAll }}; padding: 8px 12px; border-radius: 12px; text-align: center;">
                                                    {{ $statusTextPaymentAll }}
                                                </span>
                                            @endif
                                        </div>
