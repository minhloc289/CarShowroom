            ...
            <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">
                        <span class="font-semibold text-gray-900 dark:text-white">Engine Type:</span>
                        {{ $car->engine_type }}<br><br>
                        <span class="font-semibold text-gray-900 dark:text-white">Seats:</span>
                        {{ $car->seat_capacity }}<br><br>
                        <span class="font-semibold text-gray-900 dark:text-white">Max Speed:</span> {{ $car->max_speed }}
                        km/h<br><br>
                        <span class="font-semibold text-gray-900 dark:text-white">Trunk Capacity:</span>
                        {{ $car->trunk_capacity }}
                    </p>
                </div>
            </div>
