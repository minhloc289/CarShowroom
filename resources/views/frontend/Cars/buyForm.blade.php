        ...
        <div class="col-span-12 md:col-span-5 bg-white shadow-md rounded-none flex flex-col justify-between mt-4">
            <div class="flex flex-col justify-between h-[80%]">
                ...
                <div class="flex justify-between bg-gray-100">
                    ...
                    <button type="button" id="payment-tab" class="w-full text-center py-4 px-4 font-medium text-gray-700 hover:bg-gray-200  focus:outline-none" onclick="showTab('payment')" disabled>Thanh toán</button>
                </div>
                ...
                <div id="info-content" class="tab-content px-6 pt-2 pb-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-6 pt-2 pb-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" required class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4 py-2" value="{{ $user->name }}">
                        </div>
        
                        <!-- Email -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" name="email" id="email" required class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4 py-2" value="{{ $user->email }}">
                        </div>
        
                        <!-- Số điện thoại -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Số điện thoại</label>
                            <input type="tel" name="phone" id="phone" required class="block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 px-4 py-2" value="{{ $user->phone }}">
                        </div>
                        <div>
                    ...
                    <div class="p-6">
                        <div class="p-4 bg-blue-100 rounded-md shadow-md">
                            ...
                            <p class="text-gray-700 mt-2">Giá xe: <span id="car_price">{{ number_format($car->sale->sale_price ?? $car->price, 0) }}</span> VNĐ</p>
                            ...
                            <p class="text-lg font-bold text-blue-600 mt-4">Tổng cộng: <span id="total_price">{{ number_format($car->sale->sale_price ?? $car->price, 0) }}</span> VNĐ</p>
                        </div>
                    </div>
