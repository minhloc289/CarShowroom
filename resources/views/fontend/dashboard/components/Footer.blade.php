  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
        ...
        <p>
        At Merus, we bring you a premium selection of luxury cars, tailored to meet your style and performance needs. Discover models that combine cutting-edge technology, refined craftsmanship, and unmatched elegance. Visit us to find the perfect car for you.
        </p>
      </div>
      <!-- Products section -->
      <div>
