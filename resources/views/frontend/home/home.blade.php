...
<div class="flex isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div
                class="relative h-[35px] mt-[-190px] rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
        ...
        <div class="text-center">
            <h1 class="mt-[-150px] text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Discover
                Luxury Cars</h1><br>
...
<div class="flex items-center p-8 text-white h-[800px] rounded-[20px]"
    ...
    <div class="w-1/2 pl-8">
        ...
        <p class="text-gray-400 mb-4">Emphasizes the meticulous craftsmanship and luxurious interior, portraying the car as a style statement.</p>

        <p class="font-bold">Power and Performance</p>
        <p class="text-gray-400 mb-4">Describes the powerful engine and smooth performance, appealing to the thrill of driving.</p>

        <p class="font-bold">Self-Discovery and Passion</p>
        <p class="text-gray-400 mb-4">Frames each journey as a path to self-exploration, embodying a passion for speed and excellence.</p>
...
<div class="container mx-auto px-6 py-12">
        ...
        <div class="text-center">
            ...
            <p class="text-lg text-gray-400">Immerse yourself in luxury with our meticulous detailing packages tailored to your car's unique needs.</p>
        </div>
        <hr class="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <!-- Full Detail -->
            <div class="rounded-lg shadow-lg overflow-hidden">
                <img src="https://pictures.porsche.com/rtt/iris?COSY-EU-100-1711coMvsi60AAt5FwcmBEgA4qP8iBUDxPE3LUUEssTugNTb7gKOCl3UBb%25cUzW1TipaIKyGZPm21CS9ctLD6L8T7wG2Epk6a0vDdgBWTJWFk4wq1fx5%253dkF%25vUqjdTuWXsOB3iZJyN4vv39h7nw%25Xjbkdl7FJkOFmjZrgmTB8VuKQbgLk0D0UlS7h%258XsXb1qG" alt="Full detail" class="w-full h-auto object-cover">
                <div class="p-6">
