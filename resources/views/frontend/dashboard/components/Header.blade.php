    ...
    <div class="container mx-auto">
        <nav class="flex items-center justify-between p-0 lg:px-2" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12">
                ...
                <a href="#" class=" md:hover:text-blue-700 font-semibold text-gray-900 hover:underline">Compare Cars</a>
                ...
                <div  class="relative group">
                    ...
                    {{---------------- Dropdown for service ---------------}}
                        ...
                        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                            <a id="loginLink" href="{{ route('customer.login') }}" class="font-semibold text-gray-900 md:hover:text-green-700">Log in <span aria-hidden="true">&rarr;</span></a>
                        </div>
                    </nav>
                </div>
            </div>
