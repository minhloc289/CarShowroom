    ...
    <div class="relative mx-auto max-w-2xl py-[20vh] sm:py-[25vh] lg:py-[30vh] z-10">
                ...
                <div class="relative h-80 md:h-80 overflow-hidden" style="width: calc(100% + 20px);">
                    ...
                    <div class="duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche1.png') }}" alt="Car Image">
                    </div>
                    <!-- Slide 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche2.png') }}" alt="Car Image">
                    </div>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche3.png') }}" alt="Car Image">
                    </div>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche4.png') }}" alt="Car Image">
                    </div>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche5.png') }}" alt="Car Image">
                    </div>
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img class="p-0 w-full h-auto object-cover opacity-90 -translate-y-2.5"
                            style="box-sizing: content-box;" src="{{ asset('assets/img/porsche6.png') }}" alt="Car Image">
                    </div>
        ...
        <div class="flex items-center p-8 text-white h-[800px] rounded-[20px]"
            ...
            <div class="w-1/2 pl-8">
                <p class="text-3xl font-semibold text-center mb-4">"Experience the Pinnacle of Luxury and Unmatched Speed"
                </p>
                ...
                <p class="text-gray-400 mb-4">Emphasizes the meticulous craftsmanship and luxurious interior, portraying
                    the
                    car as a style statement.</p>

                <p class="font-bold">Power and Performance</p>
                <p class="text-gray-400 mb-4">Describes the powerful engine and smooth performance, appealing to the thrill
                    of
                    driving.</p>

                <p class="font-bold">Self-Discovery and Passion</p>
                <p class="text-gray-400 mb-4">Frames each journey as a path to self-exploration, embodying a passion for
                    speed
                    and excellence.</p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 py-12">
            ...
            <div class="text-center">
                ...
                <p class="text-lg text-gray-400">Immerse yourself in luxury with our meticulous detailing packages tailored
                    to
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                ...
                <div class="rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-400 mb-4">Experience the ultimate transformation with our full-detail package.
                        </p>
                        <a href="#" class="text-blue-500 hover:underline">Learn More →</a>
                    </div>
                </div>
