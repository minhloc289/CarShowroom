    ...
    <form action="{{route('rentalOrders.store')}}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="rental_price_per_day" id="rental_price_per_day" class="form-control"
                    value="{{ old('rental_price_per_day') }}" readonly>
            </div>
            <div class="col-md-4">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="deposit_amount" id="deposit_amount" class="form-control"
                value="{{ old('deposit_amount') }}" readonly>
        </div>
