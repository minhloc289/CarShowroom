...
@section('content')
    ...
    <div class="flex isolate px-6 pt-14 lg:px-8">
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div class="relative h-[35px] mt-[-190px] rounded-full px-3 py-1 text-sm text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <div class="text-center">
                <h1 class="mt-[-150px] text-balance text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">
                    Discover Luxury Cars
                </h1>
                <p class="text-pretty text-lg font-medium sm:text-xl/8 text-gray-900" style="margin-top: 350px;">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="{{ route('CustomerDashBoard.bookingform') }}" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500">
    ...
    <div class="flex items-center justify-center h-[40vh] bg-white mt-[-200px]">
        <!-- Slider container -->
        <div id="default-carousel" class="relative w-[120%] max-w-2xl bg-white rounded-lg overflow-hidden" data-carousel="static">
            <!-- Carousel wrapper -->
            ...
            <!-- Slider controls -->
            <button type="button" class="absolute top-0 left-0 z-30 flex items-center justify-center h-full px-2 cursor-pointer group focus:outline-none" data-carousel-prev onclick="updateInfo('prev')">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-600 group-hover:bg-gray-500 focus:ring-2 focus:ring-gray-500 group-focus:outline-none">
            ...
            <button type="button" class="absolute top-0 right-0 z-30 flex items-center justify-center h-full px-2 cursor-pointer group focus:outline-none" data-carousel-next onclick="updateInfo('next')">
                <span class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gray-600 group-hover:bg-gray-500 focus:ring-2 focus:ring-gray-500 group-focus:outline-none">
                    <svg class="w-3 h-3 text-white rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 9 4-4-4-4" />
    ...
    <div class="flex items-center p-8 text-white h-[800px] rounded-[20px]" style="background: radial-gradient(circle, rgb(35, 35, 35), rgb(26, 26, 26), rgb(9, 9, 9)); margin-top: 20px ">
        <!-- Image Section -->
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
            ...
            <div class=" rounded-lg shadow-lg overflow-hidden">
                <img src="https://imgd.aeplcdn.com/664x374/n/o2bupsa_1476812.jpg?q=80" alt="Entry-level detail" class="w-full h-auto object-cover">
                <div class="p-6">
                    <h3 class="text-2xl font-bold mb-2">Entry-level Detail</h3>
                    <p class="text-gray-400 mb-4">Treat your car to our entry-level detail, perfect for maintaining everyday elegance.</p>
    ...
    <!--  -->
    <div class=" items-center p-8 text-white h-[800px] rounded-[20px] " style="background: radial-gradient(circle, rgb(35, 35, 35), rgb(26, 26, 26), rgb(9, 9, 9)); margin-top: 20px">
            ...
            <div class="mt-16 grid divide-x divide-y  divide-gray-700 overflow-hidden rounded-3xl border text-gray-600 border-gray-700 sm:grid-cols-2 lg:grid-cols-4  lg:divide-y-0 xl:grid-cols-4">
              <div class="group relative bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                  <div class="relative space-y-8 py-12 p-8">
                      <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" color="white" style="color:white" height="50" width="50" xmlns="http://www.w3.org/2000/svg">
